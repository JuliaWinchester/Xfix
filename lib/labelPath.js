...
// Returns a Group object containing line and arrowhead Paths. 
	...
	pathGroup.getEndPoint = function () {
		return this.children["path"].getPointAt(this.children["path"].length);
	}
...
// Constructor for linked paper.js text label and path objects 
	...
	// Attributes for direct reference to label or pathGroup
	this.label = createLabel(labelPoint, labelContent);
	this.pathGroup = this.initArrowPath();

	// Group attribute for relative references (e.g., from hitResult)
